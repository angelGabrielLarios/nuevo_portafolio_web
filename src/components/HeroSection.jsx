...
function HeroSection() {
	return (
		<div
			id="hero"
			className="flex items-center justify-center flex-col py-20 min-h-screen"
		>
			<div className="text-center">
				...
				<article className="flex flex-col gap-2 items-center">
					...
					<a
						href="#works"
						className="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:text-md "
					>
						Ver Projectos
						<svg
							width="20px"
						...
						>
							...
							<g id="SVGRepo_iconCarrier">
								<path d="M5.293,16.707a1,1,0,0,1,1.414-1.414L11,19.586V2a1,1,0,0,1,2,0V19.586l4.293-4.293a1,1,0,0,1,1.414,1.414l-6,6a1,1,0,0,1-1.414,0Z" />
							</g>
						</svg>
					</a>
				</article>

				<article className="py-4 flex items-center justify-center gap-4">
					<a
						href="https://www.linkedin.com/in/%C3%A1ngel-gabriel-larios-acosta-84a61021b/"
						target="_blank"
						rel="noreferrer"
					>
						<svg
							...
							xmlns="http://www.w3.org/2000/svg "
							className="stroke-indigo-600 fill-indigo-600 hover:fill-indigo-700 ease-in-out "
						>
							<g id="SVGRepo_bgCarrier" strokeWidth="0" />
							<g
								id="SVGRepo_tracerCarrier"
					...
					<a
						href="https://github.com/angelGabrielLarios"
						target="_blank"
						rel="noreferrer"
					>
						<svg
